...
<body>
    ...
    <main class="post-container" style="max-width: 1000px;">
        <div class="admin-page-header">
            ...
            <a href="create.php" class="btn btn--accent" style="width: auto;">+ NUEVO JUEGO</a>
        </div>
                    ...
                    <tbody>
                        <?php foreach ($games as $game): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="edit.php?id=<?php echo $game['id']; ?>" class="text-highlight" style="margin-right: 10px;">Editar</a>
